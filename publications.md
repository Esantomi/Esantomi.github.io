...
<div style="display: flex; align-items: flex-start;">
    ...
    <div style="flex: auto;">
        <p style="margin-left: 1rem;">
        [eBook] <strong>XML(TEI) with 인문학 - 디지털인문학 시리즈</strong><br />
        <a href="https://www.ddokbaro.com/" target="_blank">김바로</a>, 지해인 외<br />
        WikiDocs, 2024 (<a href="https://wikidocs.net/book/14569" target="_blank"><i class="xi-link"></i> Link</a>)<br />
        &nbsp;➥ AKSR2024-RE02: '고문헌 데이터 설계를 위한 선행 모델 분석 및 교육 콘텐츠 구축' 프로젝트 결과물 (<i class="xi-spinner-2 xi-spin"></i> YouTube 강의 제공 예정)
        </p>
    </div>
</div>
...
<div style="display: flex; align-items: flex-start;">
    ...
    <div style="flex: auto;">
        ...
        &nbsp;➥ AKSR2023-RE07: '한국학 시맨틱 웹 구축을 위한 선행 온톨로지 모델의 탐색과 교육' 프로젝트 결과물 (<a href="https://www.youtube.com/playlist?list=PLGbGeqRyCIoevFRxa0Ng9VrKYsk8GTqOK" target="_blank"> YouTube</a> 강의 제공)
        </p>
    </div>
</div>
...
### <i class="xi-warning"></i> Copyright Notice
