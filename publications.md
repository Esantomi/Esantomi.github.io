...
<div style="display: flex; align-items: flex-start;">
    ...
    <div style="flex: auto;">
        ...
        &nbsp;➥ AKSR2023-RE07: '한국학 시맨틱 웹 구축을 위한 선행 온톨로지 모델의 탐색과 교육' 프로젝트 결과물 (<i class="xi-spinner-1"></i>Youtube 강의 제공 예정)
        </p>
    </div>
</div>
...
<div style="display: flex; align-items: flex-start;">
    ...
    <div style="flex: auto;">
        ...
        &nbsp;➥ AKSR2023-RE01: '인문학도를 위한 데이터 분석 교육 콘텐츠 편찬 -한국학 데이터를 중심으로-' 프로젝트 결과물 (<i class="xi-spinner-1"></i>Youtube 강의 제공 예정)
        </p>
    </div>
</div>
