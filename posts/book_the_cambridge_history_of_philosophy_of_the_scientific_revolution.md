...
* **범주의 역사적 유효성**
  * 다니엘 가버는 데카르트, 홉스, 가센디 등을 paradigm을 공유하기보다 각자 **아리스토텔레스를 대체하려 경쟁했던 '새로운 철학자(novatores)'로 보아야** 하며, 보일의 대중화 이후에야 비로소 공통의 틀이 안착되었다고 보았다. 
...
* **취약한 기계론적 설명들의 한계**
  * 화학이나 기상학 분야에서 입자의 모양과 현상을 무리하게 연결했던 설명들(예: 가센디의 갈고리 모양의 자성 입자, 레메리의 모공을 찌르는 뾰족한 산성 입자, 보일의 스프링 모양 공기 입자 등)은 분명 정밀한 **검증이 결여된 인식론적으로 취약한 가설들**이었다.
